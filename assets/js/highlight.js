...
var hljs = (function () {
  ...
  const HLJS = function (hljs) {
    ...
    function highlightElement(element) {
      ...
      // 소스코드 복사 공간 및 소스코드 언어 표시를 위한 div 추가 # jaejunheo 추가
      let mainCodeBlock = element.parentNode.parentNode.parentNode;
      let codeTitleBar = mainCodeBlock.appendChild(
        document.createElement("span")
      );
      let codeTitle = codeTitleBar.appendChild(document.createElement("div"));
      let copyButton = codeTitleBar.appendChild(document.createElement("div"));
      codeTitleBar.classList.add("codeTitleBar");
      ...
      // jaejunheo codeTitleBar 셋팅
      codeTitle.innerHTML = result.language;
      copyButton.innerHTML = "복사";
      copyButton.addEventListener("click", () => {
        navigator.clipboard.writeText(text);
        copyButton.classList.add("active");
        copyButton.innerHTML = "완료";
  ...
  */
    ...
    function swift(hljs) {
      ...
      const DOT_KEYWORD = {
        ...
        begin: concat(
          /\./,
          lookahead(either(...dotKeywords, ...optionalDotKeywords))
        ),
